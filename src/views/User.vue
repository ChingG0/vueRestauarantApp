<template>
  <div class="container py-5">
    <UserProfileCard :initProfile="profile" :isFollowed="isFollowed"/>
    <div class="row">
      <div class="col-md-4">
        <UserFollowingsCard :initProfile="profile"/>
        <br />
        <UserFollowersCard :initProfile="profile"/>
      </div>
      <div class="col-md-8">
        <UserCommentsCard :initProfile="profile"/>
        <br />
        <UserFavoritedRestaurantsCard :initProfile="profile"/>
      </div>
    </div>
  ...
  methods: {
    fetchData(){
      ...
      ...this.profile,
        ...
        Favorites: FavoritedRestaurants,
