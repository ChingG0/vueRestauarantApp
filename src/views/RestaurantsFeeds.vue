...
import NewestRestaurants from '../components/RestaurantsFeeds/NewestRestaurants.vue';
import NewestComments from '../components/RestaurantsFeeds/NewestComments.vue';
